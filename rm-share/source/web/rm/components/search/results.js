   ...
   Alfresco.rm.component.Results.prototype =
   {
      ...
      _setupDataTable: function RecordsResults_setupDataTable()
      {
         ...
         [
            ...
            { key: "originatingOrganization", label: me._msg("label.originatingOrganization"), field: "properties.rma_originatingOrganization", sortable: true, resizeable: true,  formatter: renderCellSafeHTML, hidden: true },
