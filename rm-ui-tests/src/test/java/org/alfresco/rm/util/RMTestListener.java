...
public class RMTestListener extends TestListenerAdapter
{
    private static Log logger = LogFactory.getLog(RMTestListener.class);
    /**
    ...
    private void takeSaveScreenShotSource(ITestResult tr)
    {
        ...
        if (instace instanceof AbstractTest)
        {
            AbstractTest abstractTest = (AbstractTest) instace;
