...
/**
 * Test the record move to rule within the unfiled records container
 *
 * @author Mark Hibbins
 * @version 2.2
 */
@Listeners(FailedTestListener.class)
public class UnfiledRecordMoveToRuleIntTest extends AbstractUnfiledCopyMoveRuleIntTestBase
{
     ...
     */
    @Test
    public void unfiledRecordsMoveToRecordTest()
    {
