...
public class FilePlanRecordCopyToRuleIntTest extends AbstractFilePlanCopyMoveRuleIntTestBase
{
     ...
     */
    @Test
    public void filedRecordsCopyToRecordTest()
    {
        navigateToFilePlan();
        createSourceCategoryAndFolder(SOURCE_CATEGORY, SOURCE_FOLDER);
        createFilePlanRule(RULE_TITLE, RuleType.COPY_TO, TARGET_FOLDER_PATH, true);
